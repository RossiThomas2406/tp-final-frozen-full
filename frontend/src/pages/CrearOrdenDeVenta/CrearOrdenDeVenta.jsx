...
const [orden, setOrden] = useState({
    id_cliente: "", 
    id_prioridad: "1", // <-- Cambia el "" por un ID que exista en tu tabla Prioridad
    fecha_entrega: "", 
    calle: "", 
    altura: "", 
    localidad: "", 
...
const handleCliente = (selectedOption) => {
  ...
  // Seteamos valores por defecto para evitar errores de base de datos
  let clientePrioridadId = "1"; 
  ...
  if (clienteId) {
    ...
    if (clienteSeleccionado) {
      // Si el cliente en la BD tiene una prioridad asignada, la usamos
